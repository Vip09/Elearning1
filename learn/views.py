...
"""
code to change password of auth_user
from django.contrib.auth.hashers import make_password
...
def acc_chapter1(request):
    ...
    for i in sz:
        ...
        ch_con_type.append(i.Chapter_Content_type)
    ...
    if not mj:
        c_p.append('Pending')
    print(ch_con_type)
    ded = zip(ch_txt_con_id, ch_txt_con, ch_cont_nmbe, ch_cont_nmbe1, c_p, ch_con_type)
